...
public partial class SpecimensForm : Form
{
    ...
    public SpecimensForm(string filename)
    {
        ...
        saveToolStripButton.Enabled = false; //Disabled for now.
        GetCSVData();
    ...
    {
        /* INCOMPLETE, WILL WORK ON LATER!
         * StreamReader streamReader = new StreamReader(FileLocationName);

        string [] col = streamReader.ReadLine().Split(",");
        foreach(string s in col)
        {
            DataGridViewColumn dataGridViewColumn = new DataGridViewColumn();
            dataGridViewColumn.HeaderText = s;
            specimensDataGridView.Columns.Add(dataGridViewColumn);
        }
        while (!streamReader.EndOfStream)
        {
            string[] row = streamReader.ReadLine().Split(",");
            DataGridViewRow dataGridViewRow = new DataGridViewRow();
            specimensDataGridView.Rows.Add(dataGridViewRow);
        }

        streamReader.Close();*/

        MessageBox.Show("Still WIP, redirecting to Main Menu");
